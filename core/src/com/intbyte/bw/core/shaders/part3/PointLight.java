package com.intbyte.bw.core.shaders.part3;
...
import com.intbyte.bw.core.shaders.part3.Light;
import com.intbyte.bw.core.shaders.part3.MainScreen;
...
public class PointLight extends Light
{
	...
	public PointLight(final com.intbyte.bw.core.shaders.part3.MainScreen mainScreen, final Vector3 position)
	{
		super(mainScreen);
	...
	public void init()
	{
		...
		camera = new PerspectiveCamera(90f, com.intbyte.bw.core.shaders.part3.MainScreen.DEPTHMAPSIZE, com.intbyte.bw.core.shaders.part3.MainScreen.DEPTHMAPSIZE);
		camera.near = 4f;
		camera.far = 70;
	...
	public void render(final ModelInstance modelInstance)
	{
		...
		if (frameBuffer == null)
		{
			frameBuffer = new FrameBufferCubeMap(Format.Alpha, com.intbyte.bw.core.shaders.part3.MainScreen.DEPTHMAPSIZE, MainScreen.DEPTHMAPSIZE, true);
		}
