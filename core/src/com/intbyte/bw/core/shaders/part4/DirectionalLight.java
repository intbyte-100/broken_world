...
public class DirectionalLight extends Light
{
	...
	public DirectionalLight(final com.intbyte.bw.core.shaders.part4.MainScreen mainScreen, final Vector3 position, final Vector3 direction)
	{
		super(mainScreen);
	...
	public void init()
	{
		...
		camera = new PerspectiveCamera(120f, com.intbyte.bw.core.shaders.part4.MainScreen.DEPTHMAPSIZE, com.intbyte.bw.core.shaders.part4.MainScreen.DEPTHMAPSIZE);
		camera.near = 1f;
		camera.far = 70;
	...
	public void render(final ModelInstance modelInstance)
	{
		...
		if (frameBuffer == null)
		{
			frameBuffer = new FrameBuffer(Format.RGBA8888, com.intbyte.bw.core.shaders.part4.MainScreen.DEPTHMAPSIZE, MainScreen.DEPTHMAPSIZE, true);
		}
