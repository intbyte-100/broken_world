...
import com.intbyte.bw.core.shaders.part4.MainScreen;
import com.intbyte.bw.core.shaders.tools.FrameBufferCubeMap;
...
public class PointLight extends Light
{
	...
	public PointLight(final com.intbyte.bw.core.shaders.part4.MainScreen mainScreen, final Vector3 position)
	{
		super(mainScreen);
	...
	public void init()
	{
		...
		camera = new PerspectiveCamera(90f, com.intbyte.bw.core.shaders.part4.MainScreen.DEPTHMAPSIZE, com.intbyte.bw.core.shaders.part4.MainScreen.DEPTHMAPSIZE);
		camera.near = 4f;
		camera.far = 70;
	...
	public void render(final ModelInstance modelInstance)
	{
		...
		if (frameBuffer == null)
		{
			frameBuffer = new FrameBufferCubeMap(Format.RGBA8888, com.intbyte.bw.core.shaders.part4.MainScreen.DEPTHMAPSIZE, MainScreen.DEPTHMAPSIZE, true);
		}
